...
const AluminiLogin = () => {
    ...
    const onSubmit = () => {
        ...
        Sigin({email, password}, "signin/alumini")
        .then(data => {
            if(data?.error) {
                setValues({
    ...
    const performRedirect = () => {
        window.location.href = "http://localhost:3000/feed/alumini";
    }
    ...
    return (
        <div className="student-login-page">
            ...
            <div className="student-login-forms">
                ...
                <button onClick={onSubmit} className="login-btn">ALUMINI LOGIN</button>
                <div className="sign-up-link">
                or <Link className="signup" to="/register/alumini">ALUMINI SIGNUP</Link>
                </div>
                </div>
