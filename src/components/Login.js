...
const Login = () => {
    ...
    const onSubmit = () => {
        ...
        Sigin({email, password}, "signin/student")
        .then(data => {
            if(data?.error) {
                setValues({
    ...
    const performRedirect = () => {
        window.location.href = "http://localhost:3000/feed/student";
    }
    ...
    return (
        <div className="student-login-page">
            ...
            <div className="student-login-forms">
                ...
                <button onClick={onSubmit} className="login-btn">STUDENT LOGIN</button>
                <div className="sign-up-link">
                or <Link className="signup" to="/register/student">STUDENT SIGNUP</Link>
                </div>
                </div>
